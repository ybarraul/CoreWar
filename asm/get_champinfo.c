...
/*   Updated: 2019/02/08 13:53:27 by sifouche    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void		champinfo_char_after_quote(t_asm *a, int i)
{
	...
	{
		ft_printf("Line %d : Wrong characters after comment |%s|\n",
				a->ln.nb, &(a->ln.line[i]));
		free_all(a);
	}
}
...
static void		get_champ_comment(t_asm *a, int fd)
{
	...
	champinfo_char_after_quote(a, i + 1);
